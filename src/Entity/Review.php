...
class Review
{
    ...
    /** @var Collection<int, IndexingDatabase> */
    ...
    public function addIndexingDatabase(IndexingDatabase $indexingDatabase): static
    {
    ...
    public function removeIndexingDatabase(IndexingDatabase $indexingDatabase): static
    {
