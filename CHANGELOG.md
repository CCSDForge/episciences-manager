## Update — 2026-09-15 15:25:23 UTC (branch: preprod)

### ✨ Features
- feat(indexing): show newest pending proposals first for journal managers (`ab8875b`) by @ZHAO
- feat(indexingDatabases):Replace DBAL enum with native enum (`04fd0fc`) by @ZHAO
- feat(indexing): add pagination to indexing database lists (`07ddf29`) by @ZHAO
- feat(indexing): add hover popover card on database names (`670fae2`) by @ZHAO
...
### 🐛 Bug Fixes
- fix(migration): add default value for empty visibility array in JSON to SET migration (`c81fe69`) by @ZHAO
- fix(i18n): update nav.journal to plural and rephrase indexing database journals label (`3021ad8`) by @ZHAO
- fix(indexing): normalize URLs to prevent duplicates with trailing slashes (`1db63c2`) by @ZHAO
...
- fix: correct flash message display (`d020c08`) by @ZHAO
- fix(config): trust reverse proxy headers to fix HTTPS URL generation (`a66c3ce`) by @Raphaël Tournoy
- fix(docker): create and chown data/ dir before PHP-FPM early root exit (`ce28040`) by @Raphaël Tournoy
- fix(docker): create Composer cache dir for www-data in PHP image (`708264b`) by @Raphaël Tournoy
- fix(auth): resolve CAS DNS and hardcoded server URL issues (`90966f6`) by @Raphaël Tournoy
...
### 📝 Documentation
- docs(migration): add deployment steps and dual-write cleanup instructions (`f45f3ec`) by @ZHAO
- docs(migration): document 2-deployment strategy for visibility JSON to ENUM/SET migration (`b43dc50`) by @ZHAO
- docs(changelog): fix truncated commit title (`8329d2f`) by @ZHAO
- docs: add docstring to queryPending method (`3a240a4`) by @ZHAO
- docs(documentation): documentation for indexing database (`b899d0f`) by @ZHAO
...
### 🧰 Maintenance
- chore: remove internal docs, keep only indexing-database-utilisation.md (`6d2582f`) by @ZHAO
- chore: remove internal docs, keep only indexing-database-utilisation.md (`c9d79dc`) by @ZHAO
- chore: add CodeRabbit config and fix URL normalization (`050c3c1`) by @ZHAO
- refactor(indexing): rename tables and columns to lowercase (`7a112e4`) by @ZHAO
- refactor the code (`0a2cd0f`) by @ZHAO
...
### 🧪 Tests
- test(indexing): add unit and E2E tests for indexing databases feature (`76da7a4`) by @ZHAO
- test configuration (`2e41b0f`) by @ZHAO
- test configuration (`7e0dc8d`) by @ZHAO

---

## Update — 2026-09-15 14:30:09 UTC (branch: preprod)
...
## Update — 2026-09-09 12:07:47 UTC (branch: preprod)
...
## Update — 2026-09-09 11:55:21 UTC (branch: develop)
...
## Update — 2026-09-08 15:18:28 UTC (branch: develop)
...
## Update — 2026-09-08 14:48:12 UTC (branch: develop)
...
## Update — 2026-09-08 14:40:34 UTC (branch: develop)
...
## Update — 2026-09-08 14:33:34 UTC (branch: develop)
...
## Update — 2026-09-08 09:25:20 UTC (branch: develop)
...
## Update — 2026-09-07 15:43:57 UTC (branch: develop)
...
## Update — 2026-09-03 11:32:11 UTC (branch: develop)
...
## Update — 2026-06-28 21:51:28 UTC (branch: preprod)
...
## Update — 2026-06-28 21:42:53 UTC (branch: preprod)
...
## Update — 2026-06-28 10:13:08 UTC (branch: preprod)
...
## Update — 2026-06-11 19:28:53 UTC (branch: preprod)
...
## Update — 2026-06-11 13:26:17 UTC (branch: preprod)
...
## Update — 2026-06-11 13:16:19 UTC (branch: preprod)
...
## Update — 2026-06-11 12:15:24 UTC (branch: preprod)
...
## Update — 2026-06-05 19:37:39 UTC (branch: preprod)
...
## Update — 2026-06-05 19:28:44 UTC (branch: preprod)
