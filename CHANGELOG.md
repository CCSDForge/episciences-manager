## Update — 2026-06-11 19:26:45 UTC (branch: develop)

### ✨ Features
- feat(entity): sync visibility JSON and SET/ENUM columns (`3fe5974`) by @ZHAO
- feat(journal): add backoffice settings page for journal metadata (`2290cf5`) by @ZHAO
- feat(resources):add clear bouton to file input (`d046c98`) by @ZHAO
- feat(resources): replace API with PHP pre-loading and fix security issues (`8a9ff83`) by @ZHAO
- feat(setting):add menu item for editors (`96f8e0f`) by @ZHAO
- feat: switch to pure Markdown storage (remove image attributes) (`a62346f`) by @ZHAO
...
### 🐛 Bug Fixes
- fix: update keyword separator to semicolon in backoffice settings (`6006ece`) by @ZHAO
- fix(resources): fix upload issues and add file size validation (`4f057d5`) by @ZHAO
- fix(resources): display news using resources in delete confirmation modal (`514eeca`) by @ZHAO
- fix(news): add server-side content length validation with translated error message (`9b9ad10`) by @ZHAO
- fix(ckeditor): normalize image alt text format (`3232376`) by @ZHAO
- fix(widget): capitalize language names in language widget (`c79f6b8`) by @ZHAO
- fix: preserve image attributes and fix visibility status (`41f4e00`) by @ZHAO
- fix(pages): preserve content language when clicking edit pencil (`020e9a8`) by @ZHAO
- fix(pages): preserve image alignment on reload and keep relative URLs (`c5f8be0`) by @ZHAO
- fix(editor): preserve image resize and alignment in Markdown (`afd714d`) by @ZHAO
- fix(editor): save Markdown directly from CKEditor GFM plugin (`465d790`) by @ZHAO
...
### 🧰 Maintenance
- refactor: differentiate frontend/backoffice settings permissions (`7dbedb8`) by @ZHAO
- refactor(settings): rename to JournalFrontendSetting for future backoffice separation (`2da6dc4`) by @ZHAO
- refactor(settings): rename to JournalFrontendSetting for future backoffice separation (`d869109`) by @ZHAO
- refactor: finalize visibility migration and improve UI sticky behavior (`575f9b1`) by @ZHAO
- refactor: replace JSON visibility columns with enum/set types (`c782c21`) by @ZHAO
- chore: update to symfony 7.4 (`be30345`) by @ZHAO
...
## Update — 2026-06-11 13:24:49 UTC (branch: develop)
...
## Update — 2026-06-11 13:15:39 UTC (branch: develop)
...
## Update — 2026-06-11 12:02:51 UTC (branch: develop)
...
## Update — 2026-06-05 19:25:07 UTC (branch: develop)
...
## Update — 2026-06-05 19:19:44 UTC (branch: develop)
...
## Update — 2026-06-05 15:15:37 UTC (branch: develop)
...
## Update — 2026-06-02 11:39:45 UTC (branch: develop)
...
## Update — 2026-06-01 09:12:40 UTC (branch: develop)
...
## Update — 2026-05-29 08:31:39 UTC (branch: develop)
...
## Update — 2026-05-29 06:28:35 UTC (branch: develop)
...
## Update — 2026-05-29 06:26:07 UTC (branch: develop)
...
## Update — 2026-05-28 14:05:09 UTC (branch: develop)
...
## Update — 2026-05-28 11:57:06 UTC (branch: develop)
...
## Update — 2026-05-28 09:34:29 UTC (branch: develop)
...
## Update — 2026-05-28 07:57:13 UTC (branch: develop)
...
## Update — 2026-05-27 20:10:42 UTC (branch: develop)
...
## Update — 2026-05-27 15:59:20 UTC (branch: develop)
...
## Update — 2026-05-26 09:35:33 UTC (branch: develop)
...
## Update — 2026-05-22 15:56:36 UTC (branch: develop)
...
## Update — 2026-05-20 11:51:10 UTC (branch: develop)
